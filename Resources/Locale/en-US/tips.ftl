...
tips-dataset-14 = Remember to touch grass in between playing Quiet Station 34 every once in a while.
...
tips-dataset-122 = Quiet Station 34 is open source! If there's a change you want to make, or a simple item you want to add, then try contributing to the game. It's not as hard as you'd think it is.
