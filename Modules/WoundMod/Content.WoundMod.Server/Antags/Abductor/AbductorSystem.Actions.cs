...
public sealed partial class AbductorSystem : SharedAbductorSystem
{
    ...
    private void AddActions(AbductorBeaconChosenBuiMsg args)
    {
        ...
        comp.HiddenActions = _wmActions.HideActions(args.Actor);
    ...
    private void RemoveActions(EntityUid actor)
    {
        ...
        _wmActions.UnHideActions(actor, comp.HiddenActions);
    }
    ...
    private void StopPulls(EntityUid ent)
    {
        ...
        if (!_pullingSystem.IsPulled(ent))
            return;
        {
            if (!TryComp<PullableComponent>(ent, out var pullableComp) || !_pullingSystem.TryStopPull(ent, pullableComp))
                return;
        }
    }
