...
namespace Content.WoundMod.Shared.Antags.Abductor;
...
public sealed class StationBeacons
{
    ...
    public required List<SharedNavMapSystem.NavMapBeacon> Beacons { get; init; }
}
[Serializable, NetSerializable]
public sealed class AbductorBeaconChosenBuiMsg : BoundUserInterfaceMessage
{
    public required SharedNavMapSystem.NavMapBeacon Beacon { get; init; }
}
[Serializable, NetSerializable]
