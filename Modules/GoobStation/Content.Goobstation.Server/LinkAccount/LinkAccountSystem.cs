...
public sealed class LinkAccountSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        Subs.CVar(_config, GoobConVars.RMCPatronLobbyMessageTimeSeconds, v => _timeBetweenLobbyMessages = TimeSpan.FromSeconds(v), true);
        Subs.CVar(_config, GoobConVars.RMCPatronLobbyMessageInitialDelaySeconds, v => _lobbyMessageInitialDelay = TimeSpan.FromSeconds(v), true);
