...
public sealed partial class SupermatterEntryContainer : BoxContainer
{
    ...
    private sealed class EngineBarEntry(Label label, ProgressBar bar, PanelContainer border, float leftSize, float rightSize, Color leftColor, Color middleColor, Color rightColor)
    {
        public readonly Label Label = label;
        public readonly ProgressBar Bar = bar;
        public readonly PanelContainer Border = border;
        public float Value;
        public readonly float LeftSize = leftSize;
        public readonly float RightSize = rightSize;
        public readonly Color LeftColor = leftColor;
        public readonly Color MiddleColor = middleColor;
        public readonly Color RightColor = rightColor;
    }
}
