...
public sealed partial class ParticleSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        _cfg.OnValueChanged(GoobConVars.ParticleQuality, OnQualityChanged, invokeImmediately: true);
        _cfg.OnValueChanged(GoobConVars.ParticleGlobalBudget, OnManualBudgetChanged, invokeImmediately: true);
    ...
    {
        base.Shutdown();
        _cfg.UnsubValueChanged(GoobConVars.ParticleQuality, OnQualityChanged);
        _cfg.UnsubValueChanged(GoobConVars.ParticleGlobalBudget, OnManualBudgetChanged);
        _proto.PrototypesReloaded -= OnPrototypesReloaded;
