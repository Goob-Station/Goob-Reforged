...
public sealed class BarkSystem : EntitySystem
{
    ...
    public void OnPreviewBark(PreviewBarkEvent ev)
    {
        ...
        PlayBark(null, new string(message),
            //false,
            proto);
    }
    ...
    private void PlayBark(EntityUid? source, string message,
        //bool whisper,
        BarkPrototype proto)
    {
        ...
        BarkPrototype proto)
    {
        ...
        /*if (whisper) still todo marty
            volume = 0.05f + (volume - 0.05f) * 0.25f;*/

        var barksVolume = _cfg.GetCVar(GoobConVars.BarksVolume);
