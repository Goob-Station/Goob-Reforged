...
public sealed partial class GraphicsTab
{
    private sealed class OptionParticleQuality : BaseOption
    {
        ...
        {
            _dropDown.Button.SelectId(_cfg.GetCVar(GoobConVars.ParticleQuality));
        }

        public override void SaveValue()
        {
            _cfg.SetCVar(GoobConVars.ParticleQuality, _dropDown.Button.SelectedId);
        }
        ...
        {
            return _dropDown.Button.SelectedId != _cfg.GetCVar(GoobConVars.ParticleQuality);
        }
